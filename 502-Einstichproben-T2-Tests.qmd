...
library(knitr)
D           = read.csv("./_data/502-einstichproben-t2tests.csv")               # Einlesen des Datensatzes
...
# Datendeskription
D      = read.csv("_data/502-einstichproben-t2tests.csv")                      # Daten einlesen
...
```{r}
# Datenbereitstellung
D         = read.csv("./_data/502-einstichproben-t2tests.csv")                 # Datensatzeinlesen 
Y         = rbind(D$y_1i, D$y_2i)                                               # Datenmatrix
