...
Änderungsrate von $f$ in $a$, also im Beispiel die Geschwindigkeit des Objektes 
zu einem Zeitpunkt $a$. 

![Newtonscher Differenzquotient](./_figures/106-newtonscher-differenzquotient){#fig-newtonscher-differenzquotient fig-align="center" width=80%}
...
diese sind in Tabelle \textcolor{blue}{5.1} zusammengstellt. Für Beweise 
verweisen wir wiederum auf die weiterführende Literatur.
...
dev.off()
```
![Ableitungen dreier elementarer Funktionen](./_figures/106-elementare-ableitungen-1){#fig-elementare-ableitungen-1 fig-align="center" width=100%}
...
![Ableitungen von Exponentialfunktion und Logarithmusfunktion](./_figures/106-elementare-ableitungen-2){#fig-elementare-ableitungen-2 fig-align="center" width=85%}
...
Für ein Beispiel zur Anwendung der Summenregel, sei
\begin{equation}
...
Für ein Beispiel zur Anwendung der Kettenregel sei
\begin{equation}
...
dev.off()
```
![Visualisierungen einer bivariaten Funktion.](./_figures/106-bivariate-funktion){#fig-bivariate-funktion fig-align="center" width=100%}
...
\frac{f(x + he_i)-f(x)}{h}
\end{equation}
die Änderung $f(x+he_i)-f(x)$ von $f$ pro Strecke $h$ in Richtung $e_i$. Wir 
...
![Partieller Newtonscher Differenzquotient](./_figures/106-partieller-newtonscher-differenzquotient){#fig-partieller-newtonscher-differenzquotient fig-align="center" width=60%}
...
dev.off()
```
![Exemplarische Gradientenwerte der bivariaten Funktion $f(x) = x_1^2 + x_2^2$.](./_figures/106-gradientbeispiel){#fig-gradientbeispiel fig-align="center" width=60%}
