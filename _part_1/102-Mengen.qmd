...
:::{#def-mengen}
## Mengen
Nach @cantor1895 ist eine *Menge* $N$ definiert als "eine Zusammenfassung von 
...
sodass gilt
\begin{equation}
\left(M = \cup_{i=1}^n N_i\right) \land \left(N_i \cap N_j = \emptyset \right) \mbox{ für } i,j = 1,...,n \mbox{ und } i \neq j.
\end{equation}
...
*Überabzählbarkeit* der reellen Zahlen. Wir vertiefen diesen Begriff am Ende dieses
Kapitels. Insbesondere gilt 
\begin{equation}
