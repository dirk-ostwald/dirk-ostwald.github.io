...
als es in @sec-varianzen der Fall war, wo lediglich *unabhängige* Zufallsvariablen 
betrachtetet wurden. Mit dem folgenden Theorem betrachten wir
...
\noindent (1) Es seien $n := 2$, $\xi_1 := \xi$, $\xi_2 := \zeta$, $a_0 := 0$, $a_1 := 1$ und $a_2 := 1$. Dann gilt mit dem Theorem zur Varianz einer Linearkombination von Zufallsvariablen
\begin{align}
\begin{split} 
\mathbb{V}(\xi + \zeta)
