...
dev.off()
```
![Konstruktion einer bivariaten Normalverteilungen.](./_figures/311-konstruktion){#fig-konstruktion fig-align="center" width=60%}
...
## Marginale, bedingte und gemeinsame Verteilungen {#sec-marginale-bedingte-und-bedingte-verteilungen}
...
![Gemeinsame Verteilungen einer marginalen und einer auf dieser bedingten normalverteilten Zufallsvariable.](./_figures/311-gemeinsame-normalverteilungen){#fig-gemeinsame-normalverteilungen fig-align="center" width=100%}
...
Daten, begründet, zweitens, wie wir in @sec-grundbegriffe-frequentistischer-inferenz 
...
sind die Analyse von Erwartungswertschätzern in @sec-punktschaetzung sowie die in @eq-generalisierung-zentraler-grenzwertsatz-lindenberg-levy erwähnte Generalisierung
...
gibt eine umfassenden Überblick zur Theorie und Anwendung der multivariaten Normalverteilung.


## Selbskontrollfragen {.unnumbered .unlisted}
\footnotesize

1. Geben Sie das Summationstransformationstheorem wieder.
1. Geben Sie das Mittelwertstransformationstheorem wieder.
