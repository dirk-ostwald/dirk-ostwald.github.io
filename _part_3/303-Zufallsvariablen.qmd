...
Die Wahrscheinlichkeiten der Elementarereignisse in $\mathcal{S}$ wiederrum erlauben 
...
fest, dass arithmetische Operationen mit reellwertigen Zufallsvariablen wiederrum 
...
jede Funktion $p : \mathcal{X} \to \mathbb{R}_{\ge 0}$, die die Normiertheiteigenschaft 
...
\end{equation}
Dann sagen wir, dass $\xi$ einer *Binomialverteilung mit Parametern $\mu \in [0,1]$
...
Zufallsvariable (vgl. @def-normalverteilte-zufallsvariable) für $\xi$ der 
...
1. Siehe @def-normalverteilte-zufallsvariable.
