...
mithilfe des Begriffs der Wahrscheinlichkeitsmassefunktion (vgl. @sec-wahrscheinlichkeitsfunktionen)
...
(2) $\mathbb{P}_\xi(\xi \in [a,b]) = \int_a^b p(x)\,dx$ für alle $a,b\in\mathbb{R}$ mit $a \le b$.
...
in @fig-normalverteilung-wdf. Man macht sich an dieser Abbildung graphisch klar, dass die WDFen von 
