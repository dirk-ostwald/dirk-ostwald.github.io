...
```{r, eval = F, echo = F}
# Abbildungsparameter
pdf(file = "./_figures/309-lindenberg-levy.pdf", width = 15, height = 5)
library(latex2exp)
par(                                                                    
family     = "sans",                                                  
mfcol      = c(1,3),                                                  
...
$\xi_i, i = 1,...,n$ mit Freiheitsgradparameter $3$ bekanntlich gilt (vgl. @sec-erwartungswerte und @sec-varianzen) 
\begin{equation}
...
![Simulation des Zentralen Grenzwertsatzes nach Lindenberg und Lévy.](./_figures/309-lindenberg-levy){#fig-lindenberg-levy fig-align="center" width=100%}
