...
\end{equation}
für $i=1,...,n$. Die Varianz des Stichprobenmittels ergibt sich also durch Teilen der Varianz
...
Zur Veranschaulichung von @thm-schwaches-gesetz-der-großen-zahlen betrachten wird 
...
unabhängig und identische Zufallsvariablen vorausgesetzt. In der *Liapunov Form* 
dagegen werden nur unabhängige Zufallsvariablen voraussetzt. In beiden 
...
Beweis verweisen wir wiederrum auf @henze2024a.
...
1. Der zentrale Grenzwertsatz nach Lindeberg und Lévy besagt, dass das die standardisierte
Summe unabhängig und identisch verteilter Zufallsvariablen asymptotisch normalverteilt ist. 
1. Der zentrale Grenzwertsatz nach Liapunov besagt, dass das standardisierte Summe unabhängig 
und nicht notwendig identisch verteilter Zufallsvariablen asymptotisch normalverteilt ist. 
