...
skalierte Mahalanobis-Distanz von $\bar{y}$ und $\mu_0$ hinsichtlich $C$ (vgl. @sec-deskriptivstatistiken). Damit gilt entsprechend, dass bei konstanter 
...
für den Einstichproben-T$^2$-Test anhand von KVF unf WDF der Einstichproben-T$^2$-Teststatistik.](./_figures/702-einstichproben-t2-testumfangkontrolle){#fig-einstichproben-t2-testumfangkontrolle fig-align="center" width=100%}
