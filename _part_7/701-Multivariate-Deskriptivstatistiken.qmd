...
$\mathbb{C}(y_i) \in \mathbb{R}^m, i = 1,...,n$. Zur konkreten Berechnung 
...
von $n$ $m$-dimensionalen Zufallvektoren $y_1, ...,y_n$ gegeben sei. 
Dann ergeben sich
\begin{itemize}
...
führt. Intuitiv nähert also auch die Kovarianz von Komponenten $x_1$ und 
$x_2$ an. Alternativ kann man die Höhe einer Mahalanobis-Distanz dabei auch 
