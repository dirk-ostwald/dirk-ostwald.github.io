...
dev.off()
```
![Ableitungen dreier elementarer Funktionen](./_figures/105-elementare-ableitungen-1){#fig-elementare-ableitungen-1 fig-align="center" width=80%}
...
![Ableitungen von Exponentialfunktion und Logarithmusfunktion](./_figures/105-elementare-ableitungen-2){#fig-elementare-ableitungen-2 fig-align="center" width=65%}
...
\end{equation}
heißt \textit{multivariate reellwertiger} Funktion. 
:::
...
\end{equation}
heißt \textit{partielle Ableitung von $f$ nach $x_i$}. $f$ heißt \textit{partiell differenzierbar in $x \in D$}, wenn $f$ für alle $i = 1,...,n$ in $x \in D$ nach $x_i$ partiell differenzierbar ist, und  $f$ heißt partiell differenzierbar, wenn $f$ für alle  $i = 1,...,n$ in allen $x \in D$ nach $x_i$ partiell differenzierbar ist.
:::
