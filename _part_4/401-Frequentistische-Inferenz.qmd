...
allerdings nichts an der fundamental zu beachtetenden Tatsache, dass Statistiken 
als Funktionen von vom Zufall abhängigen Werten selbst wiederrum Zufallsvariablen 
...
und es seien $y_1,...,y_n \sim p_\theta$ die Zufallsvariablen der Stichprobe,
die wir etwa in einem Zufallvektor $y := (y_1,...,y_n)$ zusammenfassen können. 
...
$y := (y_1,...,y_n)$. Auf Grundage dieser Realisierung beabsichtigen die Verfahren 
...
Aussagen hinsichtlich des wahren, aberunbekannten, Parameterwerts zu machen, die 
...
von Schätzern und Statistiken unter der Annahme von  $y = (y_1,...,y_n) \sim p_\theta$. 
...
denen angenommen wird, das interessierende Effekt *nicht* existieren, sogenannten *Nullhypothesen*. 
Diese Denkweise verdeutlichen wir im Rahmen der Betrachtung von und Hypothesentests.
